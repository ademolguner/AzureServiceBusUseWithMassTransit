...
{
    [MessageConsumer(MessageTypes.Topic, MessageConsts.ArticleCreate, MessageConsts.SubscritionName2)]
    public class ArticleElasticIndexConsumer : IConsumer<CreatedArticleEventValue>
    {
        private readonly IMediator _mediator;
        private readonly IMapper _mapper;

        public ArticleElasticIndexConsumer(IMediator mediator, IMapper mapper)
        {
            _mediator = mediator;
            _mapper = mapper;
        }
